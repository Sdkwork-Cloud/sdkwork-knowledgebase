...
This directory is the local SDKWork component contract for `sdkwork-knowledgebase-product`.

- Component root: `sdkwork-knowledgebase/services/sdkwork-knowledgebase-product`

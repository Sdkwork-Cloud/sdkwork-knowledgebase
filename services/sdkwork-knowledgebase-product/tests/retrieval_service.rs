...
use sdkwork_knowledgebase_product::ports::knowledge_retrieval_backend::{
    KnowledgeChunkSearchHit, KnowledgeChunkSearchRequest, KnowledgeRetrievalBackend,
    KnowledgeRetrievalBackendError,
};
use sdkwork_knowledgebase_product::ports::knowledge_retrieval_trace_store::{
...
use sdkwork_knowledgebase_product::retrieval::KnowledgeRetrievalService;
use std::sync::Mutex;

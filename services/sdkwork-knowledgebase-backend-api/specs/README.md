...
This directory is the local SDKWork component contract for `sdkwork-knowledgebase-backend-api`.

- Component root: `sdkwork-knowledgebase/services/sdkwork-knowledgebase-backend-api`

...
This directory is the local SDKWork component contract for `sdkwork-knowledgebase-storage-sqlx`.

- Component root: `sdkwork-knowledgebase/services/sdkwork-knowledgebase-storage-sqlx`

...
This directory is the local SDKWork component contract for `sdkwork-knowledgebase-app-api`.

- Component root: `sdkwork-knowledgebase/services/sdkwork-knowledgebase-app-api`

...
Purpose: API, SDK, database, and module contract changelog entries.

Owner: SDKWork Knowledgebase maintainers.

Allowed content: changelog entries for breaking, additive, deprecated, and removed operations.

...
-- baseline source: ddl/baseline/sqlite/0001_knowledgebase_legacy_baseline.sql
...
-- PostgreSQL pgvector extension is pre-installed by sdkwork-postgres db:postgres:init.
-- SQLite stores embeddings in vector_json; ANN indexes are postgres-only.
...
-- folded migration: migrations/sqlite/0002_knowledgebase_outbox_claim.up.sql
...
-- folded migration: migrations/sqlite/0003_knowledgebase_performance_indexes.up.sql
...
-- folded migration: migrations/sqlite/0004_knowledge_market_and_site_deployment.up.sql
...
-- folded migration: migrations/sqlite/0005_knowledgebase_audit_event.up.sql
...
-- folded migration: migrations/sqlite/0006_web_audit_event.up.sql

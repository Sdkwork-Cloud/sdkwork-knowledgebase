...
`powershell
cargo test -p sdkwork-router-knowledgebase-backend-api
`
"@ | Set-Content -LiteralPath crates\sdkwork-router-knowledgebase-backend-api\README.md
  @"
# Component Specs

This directory is the local SDKWork component contract for $(System.Collections.Hashtable.Name).

- Component root: sdkwork-knowledgebase/crates/sdkwork-router-knowledgebase-backend-api

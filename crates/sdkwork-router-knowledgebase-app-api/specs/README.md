...
`powershell
cargo test -p sdkwork-router-knowledgebase-app-api
`
"@ | Set-Content -LiteralPath crates\sdkwork-router-knowledgebase-app-api\README.md
  @"
# Component Specs

This directory is the local SDKWork component contract for $(System.Collections.Hashtable.Name).

- Component root: sdkwork-knowledgebase/crates/sdkwork-router-knowledgebase-app-api

...
Business services, ports, and pure use cases for SDKWork Knowledgebase.
...
`powershell
cargo test -p sdkwork-intelligence-knowledgebase-service
`
"@ | Set-Content -LiteralPath crates\sdkwork-intelligence-knowledgebase-service\README.md
  @"
# Component Specs

This directory is the local SDKWork component contract for $(System.Collections.Hashtable.Name).

- Component root: sdkwork-knowledgebase/crates/sdkwork-intelligence-knowledgebase-service

...
This directory is the local SDKWork component contract for `sdkwork-knowledgebase-contract-tests`.

- Component root: `sdkwork-knowledgebase/crates/sdkwork-knowledgebase-contract-tests`

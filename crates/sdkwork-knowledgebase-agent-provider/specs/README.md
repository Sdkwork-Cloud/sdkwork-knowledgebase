...
This directory is the local SDKWork component contract for `sdkwork-knowledgebase-agent-provider`.

- Component root: `sdkwork-knowledgebase/crates/sdkwork-knowledgebase-agent-provider`

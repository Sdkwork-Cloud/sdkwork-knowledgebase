...
This directory is the local SDKWork component contract for `sdkwork-knowledgebase-gateway-assembly`.

- Component root: `sdkwork-knowledgebase/crates/sdkwork-knowledgebase-gateway-assembly`

...
`powershell
cargo test -p sdkwork-intelligence-knowledgebase-object-key-service
`
"@ | Set-Content -LiteralPath crates\sdkwork-intelligence-knowledgebase-object-key-service\README.md
  @"
# Component Specs

This directory is the local SDKWork component contract for $(System.Collections.Hashtable.Name).

- Component root: sdkwork-knowledgebase/crates/sdkwork-intelligence-knowledgebase-object-key-service

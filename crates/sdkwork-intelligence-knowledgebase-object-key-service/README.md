...
Domain: intelligence
Capability: knowledgebase-object-key
Package type: rust-crate
Status: standard

This README is the SDKWork module entrypoint for `sdkwork-intelligence-knowledgebase-object-key-service`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.

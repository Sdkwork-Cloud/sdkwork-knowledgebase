...
App API route adapter for SDKWork Knowledgebase.
...
`powershell
cargo test -p sdkwork-routes-knowledgebase-app-api
`
"@ | Set-Content -LiteralPath crates\sdkwork-routes-knowledgebase-app-api\README.md
  @"
# Component Specs

This directory is the local SDKWork component contract for $(System.Collections.Hashtable.Name).

- Component root: sdkwork-knowledgebase/crates/sdkwork-routes-knowledgebase-app-api

...
This directory is the local SDKWork component contract for `sdkwork-knowledgebase-observability`.

- Component root: `sdkwork-knowledgebase/crates/sdkwork-knowledgebase-observability`

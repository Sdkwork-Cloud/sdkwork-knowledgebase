...
This directory is the local SDKWork component contract for `sdkwork-knowledgebase-engine-haystack`.

- Component root: `sdkwork-knowledgebase/crates/sdkwork-knowledgebase-engine-haystack`

...
This directory is the local SDKWork component contract for `sdkwork-knowledgebase-engine-flowise`.

- Component root: `sdkwork-knowledgebase/crates/sdkwork-knowledgebase-engine-flowise`

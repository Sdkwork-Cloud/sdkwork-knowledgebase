...
Domain: intelligence
Capability: knowledgebase-test-support
Package type: rust-crate
Status: standard

This README is the SDKWork module entrypoint for `sdkwork-knowledgebase-test-support`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.

...
This directory is the local SDKWork component contract for `sdkwork-knowledgebase-test-support`.

- Component root: `sdkwork-knowledgebase/crates/sdkwork-knowledgebase-test-support`

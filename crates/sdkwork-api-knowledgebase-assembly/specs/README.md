...
This directory is the local SDKWork component contract for `sdkwork-api-knowledgebase-assembly`.

- Component root: `sdkwork-knowledgebase/crates/sdkwork-api-knowledgebase-assembly`

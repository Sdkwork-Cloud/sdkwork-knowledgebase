...
const rateLimitTierByOperationId = {
  ...
  'sites.update': 'write-heavy',
  'siteReleases.create': 'write-heavy',
  'siteReleases.rollback': 'write-heavy',
  'siteHostBindings.create': 'write-heavy',
  'siteHostBindings.delete': 'write-heavy',

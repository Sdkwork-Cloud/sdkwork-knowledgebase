...
This directory is the local SDKWork component contract for `sdkwork-knowledgebase-backend-sdk`.

- Component root: `sdkwork-knowledgebase/sdks/sdkwork-knowledgebase-backend-sdk`

...
This directory is the local SDKWork component contract for `sdkwork-knowledgebase-app-sdk`.

- Component root: `sdkwork-knowledgebase/sdks/sdkwork-knowledgebase-app-sdk`
